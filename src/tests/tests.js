...
describe('Testing node Laravel Encryptor', function () {
    ...
    describe('Test what type of Errors throw Encryptor', function () {
    ...
    describe('Test Encryptor Errors', function () {
    ...
    describe('Test Encryptor compatibility with Laravel Illuminate/Encryption/Encrypter', function () {
